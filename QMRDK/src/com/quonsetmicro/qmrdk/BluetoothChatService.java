...
public class BluetoothChatService extends Fragment {
	// Debugging
		...
		public void run() {
			...
			while (true) {
				try { 
					...
					if(sendBuffer.size() < 3)
						continue;
					
					for(int n = 0; n < sendBuffer.size()-3; n++)
					{
						...
						mHandler.obtainMessage(MainActivity.MESSAGE_READ, array.length, -1, array ).sendToTarget();
						sendBuffer.clear();
					}
